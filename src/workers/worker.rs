...
enum Disease { 
    ...
    Hysteria, // More of a memetic threat than a biological one. Worker behavior is far less predictable. Could maybe take Some() value for a hyperfixation on an ActionFlag  
}

#[derive(Debug)]
pub struct Worker {
    name: String,
    current_action: ActiveState,
    states: Vec<PassiveState>,
    pub hp: i32,
    max_hp: i32,
    stamina: i32,
    max_stamina: i32,
...
impl Worker {
    pub fn new() -> Self {
        Worker { // TODO: have more randomization
            ...
            current_action: ActiveState::Active,
            states: vec![PassiveState::Happy],
            hp: 75,
            max_hp: 100,
            stamina: 75,
            max_stamina: 100,
